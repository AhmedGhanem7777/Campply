...
// const countriesList = [
//   { code: "DZ", label: "الجزائر" }, { code: "BH", label: "البحرين" }, { code: "KM", label: "جزر القمر" },
//   { code: "DJ", label: "جيبوتي" }, { code: "EG", label: "مصر" }, { code: "IQ", label: "العراق" },
//   { code: "JO", label: "الأردن" }, { code: "KW", label: "الكويت" }, { code: "LB", label: "لبنان" },
//   { code: "LY", label: "ليبيا" }, { code: "MR", label: "موريتانيا" }, { code: "MA", label: "المغرب" },
//   { code: "OM", label: "عمان" }, { code: "PS", label: "فلسطين" }, { code: "QA", label: "قطر" },
//   { code: "SA", label: "السعودية" }, { code: "SO", label: "الصومال" }, { code: "SD", label: "السودان" },
//   { code: "SY", label: "سوريا" }, { code: "TN", label: "تونس" }, { code: "AE", label: "الإمارات العربية المتحدة" },
//   { code: "YE", label: "اليمن" },
// ];
...
//           يمكنك الاطلاع على{" "}
//           <button type="button" onClick={onOpenPrivacy} className="underline hover:text-foreground transition-colors">سياسة الخصوصية</button>{" "}
//           و{" "}
//           <button type="button" onClick={onOpenTerms} className="underline hover:text-foreground transition-colors">الشروط والأحكام</button>{" "}
...
//           <DialogHeader><DialogTitle>سياسة الخصوصية – منصة كامبلي (Camply)</DialogTitle></DialogHeader>
//           <div className="space-y-4 text-sm leading-7">
//             {/* نص سياسة الخصوصية كاملاً كما في السؤال */}
//             {/* يمكنك إدخال النص هنا بنفس التنسيق */}
//           </div>
//         </DialogContent>
//       </Dialog>
...
//         <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto" dir="rtl">
//           <DialogHeader><DialogTitle>الشروط والأحكام – منصة كامبلي (Camply)</DialogTitle></DialogHeader>
//           <div className="space-y-4 text-sm leading-7">
//             {/* نص الشروط والأحكام كاملاً كما في السؤال */}
//             {/* يمكنك إدخال النص هنا بنفس التنسيق */}
//           </div>
//         </DialogContent>
//       </Dialog>
...
//         <div className="flex items-center space-x-2 space-x-reverse">
//           <Checkbox id="agree" checked={data.profile.agreeTerms} onCheckedChange={v => update({ agreeTerms: !!v })} />
//           <label htmlFor="agree" className="text-sm cursor-pointer"> أوافق على الشروط والأحكام وسياسة الخصوصيه</label>
//         </div>
//         <div className="text-xs text-muted-foreground mt-2">
//           يمكنك الاطلاع على{" "}
//           <button type="button" onClick={onOpenPrivacy} className="underline hover:text-foreground transition-colors">سياسة الخصوصية</button>{" "}
...
//         <Textarea rows={3} value={data.profile.why} onChange={e => update({ why: e.target.value })} placeholder="اكتب بإيجاز سبب رغبتك في الإدراج..." />
//       </div>
//       {/* أزلنا خانة الموافقة على الشروط من هنا */}
//     </div>
//   );
// }
...
//       {/* أضف خيارات الشروط والخصوصية هنا */}
...
//       docCountry: "",
//       why: "",
//       agreeTerms: false,  // جعلها false افتراضياً حتى يوافق المستخدم فعلياً
//     },
//     basics: { name: "", propertyType: "", website: "" },
//     description: { summary: "", guestServices: "" },
//     location: { country: "", state: "", city: "", zip: "", street: "" },
...
//       toast({ title: "[translate:تم إرسال الطلب بنجاح!]", description: "[translate:سيتم التواصل معك خلال 3-5 أيام عمل.]" });

//       setStepIndex(0);
//       setForm(f => ({
//         ...f,
//         profile: { ...f.profile, agreeTerms: false }, // Reset agreement for new submission
//         files: []
//       }));
//     } catch (err) {
//       const message = err?.response?.data?.message || "[translate:تعذر إرسال الطلب. يرجى المحاولة مرة أخرى.]";
//       toast({ title: "[translate:خطأ]", description: message, variant: "destructive" });
//     }
//   };
...
//       <section className="border-b bg-muted/40">
//         <div className="container py-8">
//           <h1 className="text-2xl md:text-3xl font-bold">[translate:انضم كمقدم مخيم]</h1>
//           <p className="text-muted-foreground mt-2">[translate:ابدأ بإنشاء ملفك الشخصي ثم أكمل بيانات المخيم خطوة بخطوة.]</p>
//         </div>
//       </section>
//       <section className="py-8">
//         <div className="container max-w-4xl">
//           <div className="mb-8">
//             <div className="flex items-center justify-center mb-4">
//               <span className="text-sm font-medium">[translate:الخطوة] {stepIndex + 1} [translate:من] {steps.length}</span>
//             </div>
//             <div className="w-full bg-gray-200 rounded-full h-2">
//               <div
//                 className="bg-primary h-2 rounded-full transition-all duration-300"
...
//           <div className="mt-6 flex items-center justify-between">
//             <Button variant="outline" onClick={() => setStepIndex(i => Math.max(i - 1, 0))} disabled={isFirst} className="inline-flex items-center gap-2">
//               <ChevronRight className="h-4 w-4 rotate-180" /> [translate:السابق]
//             </Button>
//             {!isLast ? (
//               <Button onClick={() => { if(validateStep()) setStepIndex(i => Math.min(i + 1, steps.length - 1)); }} className="inline-flex items-center gap-2">
//                 [translate:التالي] <ChevronLeft className="h-4 w-4" />
//               </Button>
//             ) : (
...
//                 [translate:إرسال الطلب] <CheckCircle2 className="h-4 w-4" />
//               </Button>
//             )}
//           </div>
//         </div>
...
//       <Dialog open={privacyOpen} onOpenChange={setPrivacyOpen}>
//         <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto" dir="rtl">
//           <DialogHeader><DialogTitle>[translate:سياسة الخصوصية – منصة كامبلي (Camply)]</DialogTitle></DialogHeader>
//           <div className="space-y-4 text-sm leading-7">
//             {/* نص سياسة الخصوصية كاملاً */}
//           </div>
//         </DialogContent>
...
//       <Dialog open={termsOpen} onOpenChange={setTermsOpen}>
//         <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto" dir="rtl">
//           <DialogHeader><DialogTitle>[translate:الشروط والأحكام – منصة كامبلي (Camply)]</DialogTitle></DialogHeader>
//           <div className="space-y-4 text-sm leading-7">
//             {/* نص الشروط والأحكام كاملاً */}
//           </div>
//         </DialogContent>
...
//   // لضمان إدخال أرقام فقط للرمز البريدي
//   const handleZipChange = (e) => {
//     const val = e.target.value;
//     if (/^\d*$/.test(val)) { // السماح فقط بالأرقام
//       update({ zip: val });
//     }
//   };
...
// // أضفنا نص الشروط والخصوصية كاملاً هنا في نوافذ الحوار داخل StepReview
// function StepReview({ data, setData, onOpenPrivacy, onOpenTerms }) {
//   const totalBeds = Object.values(data.capacity.beds || {}).reduce((s, v) => s + Number(v || 0), 0);
...
//       {/* checkbox موافقة الشروط والخصوصية على نفس السطر */}
...
//       <section className="border-b bg-muted/40">
//         <div className="container py-8">
//           <h1 className="text-2xl md:text-3xl font-bold">سجّل مُخيمك الآن</h1>
//         </div>
//       </section>
//       <section className="py-8">
//         <div className="container max-w-4xl">
...
//           <DialogHeader><DialogTitle>سياسة الخصوصية – منصة كامبلي (Camply)</DialogTitle></DialogHeader>
//           <div className="space-y-4 text-sm leading-7">
//             <p>نحن نقدر خصوصيتك ونلتزم بحماية معلوماتك الشخصية...</p>
//             {/* <p><!-- أضف نص سياسة الخصوصية الكامل هنا --> </p> */}
//           </div>
//         </DialogContent>
//       </Dialog>
//       <Dialog open={termsOpen} onOpenChange={setTermsOpen}>
...
//           <DialogHeader><DialogTitle>الشروط والأحكام – منصة كامبلي (Camply)</DialogTitle></DialogHeader>
//           <div className="space-y-4 text-sm leading-7">
//             <p>يرجى قراءة هذه الشروط والأحكام بعناية قبل استخدام منصتنا...</p>
//             {/* <p><!-- أضف نص الشروط والأحكام الكامل هنا --> </p> */}
//           </div>
//         </DialogContent>
//       </Dialog>
//     </div>
...
// // نصوص سياسة الخصوصية والشروط (لتكون داخل ال Dialog)
...
//       <section className="border-b bg-muted/40">
//         <div className="container py-8">
//           <h1 className="text-2xl md:text-3xl font-bold" style={{ textAlign: "right" }}>سجّل مُخيمك الآن</h1>
//         </div>
//       </section>
//       <section className="py-8">
//         <div className="container max-w-4xl">
//           <div className="mb-8">
//             <div className="flex items-center justify-center mb-4">
//               <span className="text-sm font-medium" style={{ textAlign: "right" }}>الخطوة {stepIndex + 1} من {steps.length}</span>
//             </div>
//             <div className="w-full bg-gray-200 rounded-full h-2">
//               <div
//                 className="bg-primary h-2 rounded-full transition-all duration-300"
...
//             {/* زر إغلاق هو جزء من Dialog وليس هنا */}
//           </DialogHeader>
...
// // تعريف المحتوى JSX منفصل خارج المكون الرئيسي لتجنب التكرار
