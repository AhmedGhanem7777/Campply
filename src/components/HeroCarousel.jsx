...
//       <button onClick={prev} className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-full p-2 transition-smooth" aria-label="الشريحة السابقة">
//         <ChevronLeft className="w-6 h-6 text-white" />
//       </button>
//       <button onClick={next} className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-full p-2 transition-smooth" aria-label="الشريحة التالية">
...
// import heroCamp2 from "@/assets/hero-camp-2.jpg";
// import heroCamp3 from "@/assets/hero-camp-3.jpg";
// // تم التعليق على heroCamp4 في الأصل
// // import heroCamp4 from "@/assets/WhatsApp Image 2025-10-20 at 00.11.27_0e48196f.jpg";
...
//       {/* الأسهم في نسخة الموبايل - أسفل النص */}
//       <div className="absolute bottom-16 md:bottom-4 inset-x-0 flex justify-center space-x-4 z-10 md:hidden">
//         <button onClick={prev} className="bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-full p-2 transition-smooth" aria-label="الشريحة السابقة">
//           <ChevronLeft className="w-6 h-6 text-white" />
//         </button>
//         <button onClick={next} className="bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-full p-2 transition-smooth" aria-label="الشريحة التالية">
//           <ChevronRight className="w-6 h-6 text-white" />
//         </button>
//       </div>

//       {/* الأسهم في الشاشات الكبيرة - على يمين ويسار الشاشة */}
//       <button onClick={prev} className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-full p-2 transition-smooth md:block hidden" aria-label="الشريحة السابقة">
//         <ChevronLeft className="w-6 h-6 text-white" />
//       </button>
//       <button onClick={next} className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-full p-2 transition-smooth md:block hidden" aria-label="الشريحة التالية">
//         <ChevronRight className="w-6 h-6 text-white" />
//       </button>
...
//       {/* الأسهم على اليمين واليسار أسفل النص */}
//       <button onClick={prev} className="absolute left-4 bottom-16 bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-full p-2 transition-smooth" aria-label="الشريحة السابقة">
//         <ChevronLeft className="w-6 h-6 text-white" />
//       </button>
//       <button onClick={next} className="absolute right-4 bottom-16 bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-full p-2 transition-smooth" aria-label="الشريحة التالية">
//         <ChevronRight className="w-6 h-6 text-white" />
//       </button>
