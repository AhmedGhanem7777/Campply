...
//               منصتك الأولى لاستكشاف وحجز أفضل المخيمات في الخليج والدول العربية
//             </p>
//           </div>
...
import { Dialog, DialogContent, DialogHeader, DialogTitle } from '@/components/ui/dialog';
import { Button } from '@/components/ui/button';
import { Tent } from 'lucide-react'; // استيراد الأيقونة نفسها المستخدمة في الهيدر
    ...
    <footer className="bg-secondary text-secondary-foreground" dir="rtl">
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* العمود 3: سياسة الخصوصية والشروط */}
          <div>
            <p className="font-bold mb-4">سياسة الخصوصية والشروط والأحكام</p>
            <ul className="space-y-2">
              <li>
