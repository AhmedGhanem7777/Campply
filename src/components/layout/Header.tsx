...
//                   to="/login"
//                   onClick={() => { setIsMenuOpen(false); window.dispatchEvent(new Event('auth-changed')); }}
//                   className="w-full inline-flex items-center justify-center gap-3 rounded-lg px-3 py-2.5
//                              bg-primary text-primary-foreground hover:bg-primary/90 transition-colors mt-2 text-base"
//                 >
...
//                   onClick={() => { setIsMenuOpen(false); logout(); }}
//                   className="w-full inline-flex items-center justify-center gap-3 rounded-lg px-3 py-2.5
//                              bg-red-600 text-white hover:bg-red-700 transition-colors mt-2 text-base"
//                 >
...
//                   to="/login"
//                   onClick={() => { setIsMenuOpen(false); window.dispatchEvent(new Event('auth-changed')); }}
//                   className="w-full inline-flex items-center justify-center gap-1 rounded-lg px-3 py-1 text-sm
//                              bg-primary text-primary-foreground hover:bg-primary/90 transition-colors mt-2"
//                 >
//                   <LogIn className="w-4 h-4" />
//                   تسجيل الدخول
...
//         {/* Actions: Auth in navbar + Settings (password only) + Mobile burger */}
//         <div className="flex flex-1 items-center justify-end gap-2">
//           {/* Auth in navbar - تظهر على كل الشاشات */}
//           {!isAuth ? (
//             <Link
//               to="/login"
//               className="inline-flex items-center justify-center rounded-lg px-3 py-2
//                          bg-gradient-to-br from-primary to-primary-hover text-primary-foreground
//                          hover:brightness-110 transition-colors text-sm md:text-base"
//               onClick={() => { setIsMenuOpen(false); setSettingsOpen(false); }}
//             >
...
//               onClick={logout}
//               className="inline-flex items-center justify-center rounded-lg px-3 py-2
//                          bg-gradient-to-br from-red-600 to-red-700 text-white hover:brightness-110 transition-colors text-sm md:text-base"
//             >
...
//               {/* أزل أزرار تسجيل الدخول وتسجيل الخروج من هذه القائمة أو دعها إذا أردت */}
...
//         {/* Actions: Settings (password only) + Mobile burger */}
//         <div className="flex flex-1 items-center justify-end gap-2">
